@extends('common')
@section('content')
<script type="text/javascript" src="{{asset('js/outlook2.js')}}"></script>
<script type="text/javascript">
    var _menus = {
        "menus": [
            {
                "menuid": "1", "icon": "icon-test2", "menuname": "控件使用",
                "menus": [
                    {"menuid": "13", "menuname": "用户管理", "icon": "icon-users", "url": "/sysuser"},
                    {"menuid": "14", "menuname": "角色管理", "icon": "icon-test1", "url": "demo2.html"},
                    {"menuid": "15", "menuname": "权限设置", "icon": "icon-set", "url": "demo.html"},
                    {"menuid": "16", "menuname": "系统", "icon": "icon-log",
                        "menus":[
                            {"menuid": "100", "menuname": "权限设置", "icon": "icon-set", "url": "demo.html"},
                            {"menuid": "101", "menuname": "权限设置", "icon": "icon-set", "url": "demo.html"},
                        ]}
                ]
            }, {
                "menuid": "8", "icon": "icon-test3", "menuname": "员工管理",
                "menus": [{"menuid": "21", "menuname": "员工列表", "icon": "icon-nav", "url": "demo.html"},
                    {"menuid": "22", "menuname": "视频监控", "icon": "icon-nav", "url": "demo1.html"}
                ]
            }, {
                "menuid": "56", "icon": "icon-test4", "menuname": "部门管理",
                "menus": [{"menuid": "31", "menuname": "添加部门", "icon": "icon-nav", "url": "demo1.html"},
                    {"menuid": "32", "menuname": "部门列表", "icon": "icon-nav", "url": "demo2.html"}
                ]
            }, {
                "menuid": "28", "icon": "icon-test5", "menuname": "财务管理",
                ...
                "menuid": "39", "icon": "icon-test6", "menuname": "商城管理",
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
    ...
    <span style="float:right; padding-right:20px;" class="head">欢迎,您 <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span>
